...
- python 深入编解码
    - 数制与字节编解码
        ...
        - [换行字符_feed_line_lf_反斜杠n](./md/287-87338-换行字符_feed_line_lf_反斜杠n.sy.md)
    ...
    - 终端控制序列
        ...
        - [[趣味拓展]VT100_演化_颜色设置_VT选项_基础色_高亮色_索引色_RGB总结](./md/332-821055-[趣味拓展]VT100_演化_颜色设置_VT选项_基础色_高亮色_索引色_RGB总结.sy.md)
    - 运算与表达式
    ...
    - 字符编码
        ...
        - [字节_Byte_存储单位_KB_MB_GB_TB](./md/386-596873-字节_Byte_存储单位_KB_MB_GB_TB.sy.md)
...
- 文本与自然语言处理NLP
        ...
        - [[专业选修]位运算符_按位与或非_bitwise_非与或](./md/442-203874-[专业选修]位运算符_按位与或非_bitwise_非与或.sy.md)
...
- 数据库
        ...
        - [驱动起来_driver_sql](./md/496-802580-驱动起来_driver_sql.sy.md)
- pythonweb
...
- 爬虫
        ...
        - [requests_模块](./md/552-192576-requests_模块.sy.md)
...
- 计算机发展史
        ...
        - [[趣味拓展]字型码_字符字型编码_点阵字库_ascii演化](./md/593-596742-[趣味拓展]字型码_字符字型编码_点阵字库_ascii演化.sy.md)
        - [[趣味拓展]Code_page_437_IBM_5150_点阵式字形码_显示器效果](./md/594-803250-[趣味拓展]Code_page_437_IBM_5150_点阵式字形码_显示器效果.sy.md)
        - [[趣味拓展]汉字打印机_点阵式打字机_汉字字形码](./md/595-820491-[趣味拓展]汉字打印机_点阵式打字机_汉字字形码.sy.md)
        - [opencv_安装_图片的读写与查看](./md/596-967294-opencv_安装_图片的读写与查看.sy.md)
        - [绘制文字](./md/597-1189944-绘制文字.sy.md)
        - [滑动条事件](./md/598-1189945-滑动条事件.sy.md)
        - [图片文件的结构](./md/599-1189939-图片文件的结构.sy.md)
        - [灰度图像矩阵结构](./md/600-967295-灰度图像矩阵结构.sy.md)
        - [numpy_ndarray_arange_zeros_ones_empty](./md/601-2077219-numpy_ndarray_arange_zeros_ones_empty.sy.md)
        - [numpy_ndarray_矩阵维度_形状_变形_索引](./md/602-2077223-numpy_ndarray_矩阵维度_形状_变形_索引.sy.md)
        - [灰度图的矩形选区复制与粘贴](./md/603-1189940-灰度图的矩形选区复制与粘贴.sy.md)
        - [阈值ThreshHold](./md/604-1189960-阈值ThreshHold.sy.md)
        - [直方图_Histogram_](./md/605-1852955-直方图_Histogram_质量分布图_)
        - [色阶调整_levels_黑场_白场_输入_输出](./md/606-1853000-色阶调整_levels_黑场_白场_输入_输出.sy.md)
        - [BGR色彩模式下图像的矩阵结构](./md/608-1189941-BGR色彩模式下图像的矩阵结构.sy.md)
        - [BGR色彩模式图像缩放](./md/609-1189943-BGR色彩模式图像缩放.sy.md)
        - [BGR色彩模式下图像的切割与拼合](./md/610-1189942-BGR色彩模式下图像的切割与拼合.sy.md)
        - [BGR图像中通道的分离与融合](./md/611-1852935-BGR图像中通道的分离与融合.sy.md)
        - [更多色彩空间LAB_YUV](./md/612-2066132-更多色彩空间LAB_YUV.sy.md)
        - [HSV色彩模式](./md/613-1189946-HSV色彩模式.sy.md)
        - [几何变换_翻转_缩放_旋转_透视变型](./md/614-1189947-几何变换_翻转_缩放_旋转_透视变型.sy.md)
        - [[词根溯源]affine_仿射变形](./md/615-2070630-[词根溯源]affine_仿射变形.sy.md)
        - [图形的绘制_线段_矩形_圆形](./md/616-1189948-图形的绘制_线段_矩形_圆形.sy.md)
        - [图形的绘制_配合图像_文字_滚动条_多边形](./md/617-1817165-图形的绘制_配合图像_文字_滚动条_多边形.sy.md)
        - [渐变效果](./md/618-1189949-渐变效果.sy.md)
        - [随机的引入](./md/619-1189951-随机的引入.sy.md)
        - [三角函数的引用](./md/620-1189952-三角函数的引用.sy.md)
        - [多边形的绘制](./md/621-1189953-多边形的绘制.sy.md)
        - [满屏的字符_80_25](./md/622-1189955-满屏的字符_80_25.sy.md)
        - [鼠标键盘事件_画笔的原理](./md/623-1189954-鼠标键盘事件_画笔的原理.sy.md)
        - [键盘响应事件](./md/624-2065602-键盘响应事件.sy.md)
        - [图像的数学运算](./md/625-1189961-图像的数学运算.sy.md)
        - [图像的按位逻辑运算](./md/626-2065764-图像的按位逻辑运算.sy.md)
        - [半透明蒙版的应用](./md/627-1189950-半透明蒙版的应用.sy.md)
        - [数据增强_data_argmentation](./md/628-2579100-数据增强_data_argmentation.sy.md)
        - [动画效果](./md/629-1830837-动画效果.sy.md)
        - [时钟制作_设置字体_加载ttf_PIL_Pillow](./md/630-1189956-时钟制作_设置字体_加载ttf_PIL_Pillow.sy.md)
        - [gif文件格式的读写](./md/631-1189957-gif文件格式的读写.sy.md)
        - [补间插值效果](./md/632-1189958-补间插值效果.sy.md)
        - [视频](./md/633-1189959-视频.sy.md)
        - [图像的权重](./md/634-1189962-图像的权重.sy.md)
        - [视频中的音频pymovie](./md/635-1189963-视频中的音频pymovie.sy.md)
        - [将视频转化为字符画](./md/636-610550-将视频转化为字符画.sy.md)
        - [blender的安装和工作流_workflow](./md/637-1817244-blender的安装和工作流_workflow.sy.md)
        - [添加立方体_Cube_调用函数_默认参数](./md/638-2015968-添加立方体_Cube_调用函数_默认参数.sy.md)
        - [排队与布阵_Location_位置信息_立方体_xyz_移动_位移](./md/639-2019505-排队与布阵_Location_位置信息_立方体_xyz_移动_位移.sy.md)
        - [rotation_旋转_角度值_弧度制转化](./md/640-2027973-rotation_旋转_角度值_弧度制转化.sy.md)
        - [父子关系_嵌套关系_parent_child](./md/641-2112830-父子关系_嵌套关系_parent_child.sy.md)
        - [C919大飞机_构造飞机_代码细化](./md/642-2112839-C919大飞机_构造飞机_代码细化.sy.md)
        - [三向_旋转head_航向轴_pitch_俯仰轴_bank_横滚轴](./md/643-2552172-三向_旋转head_航向轴_pitch_俯仰轴_bank_横滚轴.sy.md)
        - [飞机排成阵列_一字长蛇阵_人字_方阵_雁形之阵](./md/644-2564913-飞机排成阵列_一字长蛇阵_人字_方阵_雁形之阵.sy.md)
        - [颜色设置_color_Material_材质_diffuse_color](./md/645-2685818-颜色设置_color_Material_材质_diffuse_color.sy.md)
        - [摄影机的控制_camera_控制摄像机](./md/646-2685823-摄影机的控制_camera_控制摄像机.sy.md)
        - [渲染过程_render_灯光设置_渲染器设置_导出png](./md/647-2685828-渲染过程_render_灯光设置_渲染器设置_导出png.sy.md)
        - [灯光效果_聚光灯_spot_light_功率](./md/648-2552168-灯光效果_聚光灯_spot_light_功率.sy.md)
        - [优秀作品展映_器物篇](./md/649-2716064-优秀作品展映_器物篇.sy.md)
        - [优秀作品展映_人物篇](./md/650-2731665-优秀作品展映_人物篇.sy.md)
        - [函数封装_静态建模总结](./md/651-2731673-函数封装_静态建模总结.sy.md)
        - [关键帧的设置_物体的运动_动画的渲染与查看feh](./md/652-2685177-关键帧的设置_物体的运动_动画的渲染与查看feh.sy.md)
        - [灯光的运动_颜色的变化](./md/653-2705047-灯光的运动_颜色的变化.sy.md)
        - [摄影机的运动](./md/654-2717037-摄影机的运动.sy.md)
        - [运动的总结](./md/655-2733716-运动的总结.sy.md)
        - [输出当前帧号_当前时间_关键帧_初始化场景](./md/656-2705095-输出当前帧号_当前时间_关键帧_初始化场景.sy.md)
        - [动画补间插值方式_interpolation_linear_function](./md/657-2716007-动画补间插值方式_interpolation_linear_function.sy.md)
        - [Mesh_网格_效果](./md/658-2685809-Mesh_网格_效果.sy.md)
        - [点线面的建模方法_verticle_edge_face_mesh](./md/659-2716071-点线面的建模方法_verticle_edge_face_mesh.sy.md)
        - [修改器的使用方法_bevel_倒角](./md/660-2716076-修改器的使用方法_bevel_倒角.sy.md)
        - [曲线_spline](./md/661-2731669-曲线_spline.sy.md)
        - [搭建基础环境](./md/662-1817168-搭建基础环境.sy.md)
- python 语言基础
        - [[趣味拓展]大型机的衰落_Dec小型机崛起_PDP_VAX网络](./md/663-643544-[趣味拓展]大型机的衰落_Dec小型机崛起_PDP_VAX网络.sy.md)
        - [[趣味拓展]嬉皮士运动_垮掉的一代_LSD_致幻剂_全球概览](./md/664-1114859-[趣味拓展]嬉皮士运动_垮掉的一代_LSD_致幻剂_全球概览.sy.md)
        - [[趣味拓展]极客起源_wozniac_苹果公司_Jobs_Wozniac](./md/665-663918-[趣味拓展]极客起源_wozniac_苹果公司_Jobs_Wozniac.sy.md)
